...
origin_lat, origin_lon = 36.144653, -95.830632
is_ampm_clock = False
...
def get_args():
    ...
    parser.add_argument('-u', '--username', help='Username', default='defnotbryce')
    parser.add_argument('-p', '--password', help='Password', default='defnotpassword')
    parser.add_argument(
        '-l', '--location', type=parse_unicode, help='Location', default='Tulsa, OK')
